...
TSharedPtr<FVoxelCompilationNode> UVoxelNode_GeneratorSamplerBase::GetCompilationNode(const FVoxelGraphContext& Context) const
{
...
public:
	...
	FVoxelGeneratorSamplerComputeNode(const UVoxelNode_SingleGeneratorSamplerBase& Node, const FVoxelCompilationNode& CompilationNode)
		...
		, Generator(Node.GetParameter(CompilationNode))
...
protected:
	const FVoxelGeneratorVariableHelper Generator;
