                                                       ...
                                                       const FVector& OldVelocity)
{
	...
	{
		if (bIsInjuredMovementComponent)
		{
			const float UpdateMaxWalkSpeed = CurrentMovementSettings.GetSpeedForGait(EALSGait::Walking);
			MaxWalkSpeed = UpdateMaxWalkSpeed;
			MaxWalkSpeedCrouched = UpdateMaxWalkSpeed;

			bRequestMovementSettingsChange = false;
		}
		else if (!bIsInjuredMovementComponent)
		{
