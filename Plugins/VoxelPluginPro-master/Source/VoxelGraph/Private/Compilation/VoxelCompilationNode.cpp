...
FVoxelCompilationNode::FVoxelCompilationNode(EVoxelCompilationNodeType Type, const FVoxelGraphContext& Context, const UVoxelNode& Node)
	: Node(Node)
	, Context(Context)
	, PrivateType(Type)
{
...
FVoxelCompilationNode::FVoxelCompilationNode(
	EVoxelCompilationNodeType Type,
