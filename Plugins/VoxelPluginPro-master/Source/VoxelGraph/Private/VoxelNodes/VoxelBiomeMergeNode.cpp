...
TSharedPtr<FVoxelCompilationNode> UVoxelNode_BiomeMerge::GetCompilationNode(const FVoxelGraphContext& Context) const
{
	auto* BiomeMerge = new FVoxelBiomeMergeCompilationNode(Context, *this);
