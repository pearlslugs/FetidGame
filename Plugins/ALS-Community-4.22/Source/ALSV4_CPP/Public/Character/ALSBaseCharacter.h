...
public:
	...
	//combat logic
	//combat enums
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "CombatEnums")
		EDefencePosition CharacterDefensePosition;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "CombatEnums")
		EOffensePosition CharacterOffensivePosition;
	FORCEINLINE UFUNCTION(BlueprintCallable, Category = "CombatEnums")
		void SetDefensePosition(EDefencePosition State) { CharacterDefensePosition = State; }
	FORCEINLINE UFUNCTION(BlueprintCallable, Category = "CombatEnums")
		EDefencePosition GetDefensePosition() { return CharacterDefensePosition; }
	FORCEINLINE UFUNCTION(BlueprintCallable, Category = "CombatEnums")
		void SetOffensePosition(EOffensePosition State) { CharacterOffensivePosition = State; }
	FORCEINLINE UFUNCTION(BlueprintCallable, Category = "CombatEnums")
		EOffensePosition GetOffensivePosition() { return CharacterOffensivePosition; }
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "CombatEnums")
		EOffensePosition IncomingOffensivePosition;
	FORCEINLINE UFUNCTION(BlueprintCallable, Category = "CombatEnums")
		void SetIncomingOffensivePosition(EOffensePosition State) { IncomingOffensivePosition = State; }
	FORCEINLINE UFUNCTION(BlueprintCallable, Category = "CombatEnums")
		EOffensePosition GetIncomingOffensivePosition() { return IncomingOffensivePosition; }
	// combat bools

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "CombatLogic")
		bool bIsAttacking;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "CombatLogic")
		bool bIsLockedOn;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "CombatLogic")
		bool bISCombatMovement;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "CombatLogic")
		bool bIsCombatStepping;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "CombatLogic")
		bool bShouldParry;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "CombatLogic")
		bool bIsInjured;
	...
	//combat floats
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "CombatLogic")
		float DeltaWalkCurve;

	//combat functions
	void StopAttacking();
	UFUNCTION(BlueprintCallable)
		FString SelectBodyPart(FName BoneName, FAttackType IncomingAttack);

	bool IsHand(FString BoneName);

	FString GetLeftOrRight(FString Position);

	// Bones
	// all sockets
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "BoneInfo")
		TArray<FName> BoneList;

	UFUNCTION(BlueprintCallable)
		void SetBoneListFromNewBoneName(FName NewBoneName);

	UFUNCTION(BlueprintCallable)
		void AssessTarget(AActor* CombatTarget);
	//combat references
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "CombatLogic")
		AALSBaseCharacter* CombatHumanoidTarget;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "CombatLogic")
		AActor* CombatTarget;
