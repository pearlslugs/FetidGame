...
TSharedPtr<FVoxelCompilationNode> UVoxelNode_CompileTimeConstant::GetCompilationNode(const FVoxelGraphContext& Context) const
{
	auto Result = MakeShared<FVoxelCompileTimeConstantCompilationNode>(Context, *this);
	Result->Name = Name;
	return Result;
}
