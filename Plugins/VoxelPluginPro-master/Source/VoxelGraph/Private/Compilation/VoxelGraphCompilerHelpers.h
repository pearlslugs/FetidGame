...
{
	TSharedRef<FVoxelCompilationNode> GetPassthroughNode(EVoxelPinCategory Category, const FVoxelGraphContext& Context, const TArray<const UVoxelNode*>& SourceNodes = {});
