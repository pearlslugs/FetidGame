...
TSharedPtr<FVoxelCompilationNode> UVoxelNode::GetCompilationNode(const FVoxelGraphContext& Context) const
{
	return MakeShared<FVoxelDefaultCompilationNode>(Context, *this);
}
