...
public:
	...
	FVoxelGraphCompiler(const FVoxelGraphContext& Context, const TSharedRef<FVoxelGraphErrorReporter>& ErrorReporter);
	FVoxelGraphCompiler(const FVoxelGraphContext& Context, UVoxelGraphGenerator* Graph);
