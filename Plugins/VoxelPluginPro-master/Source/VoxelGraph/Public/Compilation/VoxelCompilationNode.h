...
private:
	...
	FVoxelCompilationNode(EVoxelCompilationNodeType Type, const FVoxelGraphContext& Context, const UVoxelNode& Node);
	FVoxelCompilationNode(EVoxelCompilationNodeType Type, const FVoxelGraphContext& Context, const UVoxelNode& Node,
...
protected:
	...
	{
		auto NewNode = MakeShared<T>(Context, Node, TArray<EVoxelPinCategory>(), TArray<EVoxelPinCategory>());
...
{
public:
	TVoxelCompilationNode(const FVoxelGraphContext& Context, const UVoxelNode& Node)
		: InParent(InType, Context, Node)
	{
	}
	TVoxelCompilationNode(
		const FVoxelGraphContext& Context,
		const UVoxelNode& Node,
		const TArray<EVoxelPinCategory>& InputCategories,
		const TArray<EVoxelPinCategory>& OutputCategories)
		: InParent(InType, Context, Node, InputCategories, OutputCategories)
	{
	}
