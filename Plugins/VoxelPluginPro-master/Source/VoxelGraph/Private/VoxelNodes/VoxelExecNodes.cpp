...
TSharedPtr<FVoxelCompilationNode> UVoxelNode_FunctionSeparator::GetCompilationNode(const FVoxelGraphContext& Context) const
{
	return MakeShared<FVoxelFunctionSeparatorCompilationNode>(Context, *this);
}
...
TSharedPtr<FVoxelCompilationNode> UVoxelNode_FlowMerge::GetCompilationNode(const FVoxelGraphContext& Context) const
{
	return MakeShared<FVoxelFlowMergeCompilationNode>(Context, *this);
}
