...
FString FVoxelDataAssetVariable::GetLocalVariableFromExposedOne(const FString& ExposedNameAccessor) const
{
	return FString::Printf(
		TEXT("%s ? %s->GetData() : MakeVoxelShared<FVoxelDataAssetData>()"),
...
FVoxelGeneratorVariable::FVoxelGeneratorVariable(const UVoxelExposedNode& Node, const FVoxelGeneratorPicker& Generator)
	: FVoxelExposedVariable(
		Node,
		FVoxelCppUtils::TypeToString<FVoxelGeneratorVariableHelper>(),
		FVoxelCppUtils::TypeToString<FVoxelGeneratorPicker>(),
...
FVoxelNameVariable::FVoxelNameVariable(const UVoxelExposedNode& Node, FName Name)
	: FVoxelExposedVariable(
		Node,
		FVoxelCppUtils::TypeToString<FName>(),
		FVoxelCppUtils::TypeToString<FName>(),
		FVoxelCppUtils::LexToCpp(Name))
{
}
