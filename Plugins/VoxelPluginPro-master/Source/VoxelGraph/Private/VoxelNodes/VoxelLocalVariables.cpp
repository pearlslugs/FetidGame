...
TSharedPtr<FVoxelCompilationNode> UVoxelLocalVariableDeclaration::GetCompilationNode(const FVoxelGraphContext& Context) const
{
	return MakeShared<FVoxelLocalVariableDeclarationCompilationNode>(Context, *this);
}
...
TSharedPtr<FVoxelCompilationNode> UVoxelLocalVariableUsage::GetCompilationNode(const FVoxelGraphContext& Context) const
{
	return MakeShared<FVoxelLocalVariableUsageCompilationNode>(Context, *this);
}
