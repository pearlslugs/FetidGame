...
TSharedPtr<FVoxelCompilationNode> UVoxelNode_StaticClampFloat::GetCompilationNode(const FVoxelGraphContext& Context) const
{
...
TSharedPtr<FVoxelCompilationNode> UVoxelNode_GetRangeAnalysis::GetCompilationNode(const FVoxelGraphContext& Context) const
{
	return MakeShared<FVoxelGetRangeAnalysisCompilationNode>(Context, *this);
}
...
TSharedPtr<FVoxelCompilationNode> UVoxelNode_SmartMin::GetCompilationNode(const FVoxelGraphContext& Context) const
{
	const auto Node = MakeShared<FVoxelSmartMinMaxCompilationNode>(Context, *this);
	Node->bIsMin = true;
	return Node;
}
...
TSharedPtr<FVoxelCompilationNode> UVoxelNode_SmartMax::GetCompilationNode(const FVoxelGraphContext& Context) const
{
	const auto Node = MakeShared<FVoxelSmartMinMaxCompilationNode>(Context, *this);
	Node->bIsMin = false;
	return Node;
