...
public:
	...
	//combat variables
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "ALS|Combat")
	float DeltaWalkTime;
	float ClampedDeltaWalkTime;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Combat |Combat")
	float StepNumber;

	//Montages
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Combat |Combat")
	class UAnimMontage* StepMontage;
	
	//combat timer
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Combat |Combat")
	FTimerHandle StepResetTimer;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "ALS|Combat")
	bool bShouldCombatStep;
	bool bShouldForce;

	//combat functions
	UFUNCTION(BlueprintCallable, Category = "ALS|Combat")
	void PlayWalkingBlendAnimation();
	UFUNCTION(BlueprintCallable, Category = "ALS|Combat")
	void ResetWalkAndSetOverlay();
	// animation
