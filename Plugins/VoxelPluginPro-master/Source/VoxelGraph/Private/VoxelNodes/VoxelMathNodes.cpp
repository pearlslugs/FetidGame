...
TSharedPtr<FVoxelCompilationNode> UVoxelNode_SwitchInt::GetCompilationNode(const FVoxelGraphContext& Context) const
{
	return MakeShared<FVoxelSwitchCompilationNode>(Context, *this);
}
GENERATED_VOXELNODE_IMPL
(
...
TSharedPtr<FVoxelCompilationNode> UVoxelNode_SwitchFloat::GetCompilationNode(const FVoxelGraphContext& Context) const
{
	return MakeShared<FVoxelSwitchCompilationNode>(Context, *this);
}
GENERATED_VOXELNODE_IMPL
...
TSharedPtr<FVoxelCompilationNode> UVoxelNode_SwitchColor::GetCompilationNode(const FVoxelGraphContext& Context) const
{
	return MakeShared<FVoxelSwitchCompilationNode>(Context, *this);
}
GENERATED_VOXELNODE_IMPL
