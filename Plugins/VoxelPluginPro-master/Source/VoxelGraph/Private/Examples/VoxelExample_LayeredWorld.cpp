...
public:
	...
	public:
		...
		struct FBufferXY
		{
			...
			v_flt Variable_43; // 2D Simplex Noise output 0
	...
	private:
		...
		void Function0_XYZWithoutCache_Init(const FVoxelGeneratorInit& InitStruct)
		{
			...
			_2D_Simplex_Noise_0_Noise.SetSeed(FVoxelGraphSeed(1337));
		...
		void Function0_X_Compute(const FVoxelContext& Context, FBufferX& BufferX) const
		{
			...
			// X
			BufferX.Variable_44 = Context.GetLocalX();
		...
		void Function0_XYWithCache_Compute(const FVoxelContext& Context, FBufferX& BufferX, FBufferXY& BufferXY) const
		{
			...
			// Y
			v_flt Variable_45; // Y output 0
			Variable_45 = Context.GetLocalY();
			...
			// 2D Simplex Noise
			BufferXY.Variable_43 = _2D_Simplex_Noise_0_Noise.GetSimplex_2D(BufferX.Variable_44, Variable_45, v_flt(0.02f));
			BufferXY.Variable_43 = FMath::Clamp<v_flt>(BufferXY.Variable_43, -1.197461, 1.197463);
		...
		void Function0_XYZWithCache_Compute(const FVoxelContext& Context, const FBufferX& BufferX, const FBufferXY& BufferXY, FOutputs& Outputs) const
		{
			...
			// 2D Noise SDF.*
			v_flt Variable_71; // 2D Noise SDF.* output 0
			Variable_71 = Variable_30 * v_flt(50.0f);
			
			// Cave Layer.*
			v_flt Variable_67; // Cave Layer.* output 0
			Variable_67 = Variable_25 * v_flt(50.0f);
			
			// Cave Layer.*
			v_flt Variable_59; // Cave Layer.* output 0
			Variable_59 = Variable_17 * v_flt(50.0f);
			
			// Cave Layer.*
			v_flt Variable_52; // Cave Layer.* output 0
			Variable_52 = Variable_21 * v_flt(50.0f);
			
			// Cave Layer.-
			v_flt Variable_51; // Cave Layer.- output 0
			Variable_51 = Variable_52 - Variable_1;
			
			// Cave Layer.1 - X
			v_flt Variable_56; // Cave Layer.1 - X output 0
			Variable_56 = 1 - Variable_59;
			
			// 2D Noise SDF.+
			v_flt Variable_3; // 2D Noise SDF.+ output 0
			Variable_3 = Variable_71 + v_flt(0.0f);
			
			// Cave Layer.-
			v_flt Variable_66; // Cave Layer.- output 0
			Variable_66 = Variable_67 - Variable_4;
			
			// Cave Layer.1 - X
			v_flt Variable_49; // Cave Layer.1 - X output 0
			Variable_49 = 1 - Variable_52;
			
			// Cave Layer.-
			v_flt Variable_58; // Cave Layer.- output 0
			Variable_58 = Variable_59 - Variable_0;
			
			// Cave Layer.1 - X
			v_flt Variable_64; // Cave Layer.1 - X output 0
			Variable_64 = 1 - Variable_67;
			
			// Cave Layer.*
			v_flt Variable_61; // Cave Layer.* output 0
			Variable_61 = v_flt(0.2f) * Variable_56;
			...
			Variable_69 = v_flt(0.2f) * Variable_64;
			
			// Cave Layer.*
			v_flt Variable_54; // Cave Layer.* output 0
			Variable_54 = v_flt(0.2f) * Variable_49;
			
			// 2D Noise SDF.-
			v_flt Variable_70; // 2D Noise SDF.- output 0
			Variable_70 = Variable_29 - Variable_3;
			
			// * -1
			v_flt Variable_34; // * -1 output 0
			Variable_34 = Variable_70 * -1;
			
			// Cave Layer.-
			v_flt Variable_50; // Cave Layer.- output 0
			Variable_50 = Variable_1 - Variable_54;
			
			// Cave Layer.-
			v_flt Variable_57; // Cave Layer.- output 0
			Variable_57 = Variable_0 - Variable_61;
			
			// Cave Layer.-
			v_flt Variable_65; // Cave Layer.- output 0
			Variable_65 = Variable_4 - Variable_69;
			
			// Cave Layer.Smooth Union
			v_flt Variable_55; // Cave Layer.Smooth Union output 0
			Variable_55 = FVoxelSDFNodeFunctions::SmoothUnion(Variable_57, Variable_58, v_flt(100.0f));
			
			// Cave Layer.Smooth Union
			v_flt Variable_48; // Cave Layer.Smooth Union output 0
			Variable_48 = FVoxelSDFNodeFunctions::SmoothUnion(Variable_50, Variable_51, v_flt(100.0f));
			
			// Cave Layer.Smooth Union
			v_flt Variable_63; // Cave Layer.Smooth Union output 0
			Variable_63 = FVoxelSDFNodeFunctions::SmoothUnion(Variable_65, Variable_66, v_flt(100.0f));
			
			// Cave Layer.+
			v_flt Variable_68; // Cave Layer.+ output 0
			Variable_68 = Variable_63 + v_flt(25.0f);
			
			// Cave Layer.+
			v_flt Variable_53; // Cave Layer.+ output 0
			Variable_53 = Variable_48 + v_flt(25.0f);
			
			// Cave Layer.+
			v_flt Variable_60; // Cave Layer.+ output 0
			Variable_60 = Variable_55 + v_flt(25.0f);
			
			// Max (float)
			v_flt Variable_2; // Max (float) output 0
			Variable_2 = FVoxelNodeFunctions::Max<v_flt>(Variable_7, FVoxelNodeFunctions::Max<v_flt>(Variable_60, FVoxelNodeFunctions::Max<v_flt>(Variable_53, FVoxelNodeFunctions::Max<v_flt>(Variable_68, Variable_34))));
			
			// *
			v_flt Variable_46; // * output 0
			Variable_46 = BufferXY.Variable_43 * Variable_2;
			
			// *
			v_flt Variable_47; // * output 0
			Variable_47 = Variable_46 * v_flt(-1.0f);
			
			// Smooth Intersection
			v_flt Variable_12; // Smooth Intersection output 0
			Variable_12 = FVoxelSDFNodeFunctions::SmoothIntersection(Variable_47, Variable_13, v_flt(5.0f));
			
			// Set High Quality Value.*
			v_flt Variable_62; // Set High Quality Value.* output 0
			Variable_62 = Variable_12 * v_flt(0.2f);
			
			Outputs.Value = Variable_62;
		}
		...
		void Function0_XYZWithoutCache_Compute(const FVoxelContext& Context, FOutputs& Outputs) const
		{
			...
			// 2D Simplex Noise
			v_flt Variable_43; // 2D Simplex Noise output 0
			Variable_43 = _2D_Simplex_Noise_0_Noise.GetSimplex_2D(Variable_44, Variable_45, v_flt(0.02f));
			Variable_43 = FMath::Clamp<v_flt>(Variable_43, -1.197461, 1.197463);
			...
			// *
			v_flt Variable_46; // * output 0
			Variable_46 = Variable_43 * Variable_2;
	...
	public:
		...
		struct FBufferConstant
		{
			...
			TVoxelRange<v_flt> Variable_22; // 2D Simplex Noise output 0
			TVoxelRange<v_flt> Variable_44; // Cave Layer.* output 0
			TVoxelRange<v_flt> Variable_29; // Cave Layer.* output 0
			...
			TVoxelRange<v_flt> Variable_46; // Cave Layer.* output 0
			TVoxelRange<v_flt> Variable_31; // Cave Layer.* output 0
			TVoxelRange<v_flt> Variable_38; // Cave Layer.* output 0
		};
		...
		void Init(const FVoxelGeneratorInit& InitStruct)
		{
			...
			////////////////////////////////////////////////////
			{
				...
				////////////////////////////////////////////////////
				{
					...
					// Init of 3D Perlin Noise
					_3D_Perlin_Noise_4_Noise.SetSeed(FVoxelGraphSeed(13339));
					...
					// Init of 3D Perlin Noise
					_3D_Perlin_Noise_7_Noise.SetSeed(FVoxelGraphSeed(1339));
			...
			////////////////////////////////////////////////////
			{
				...
				// 2D Simplex Noise
				BufferConstant.Variable_22 = { -1.197461f, 1.197463f };
				...
				// Cave Layer.*
				BufferConstant.Variable_44 = Variable_17 * TVoxelRange<v_flt>(50.0f);
				
				// 2D Noise SDF.*
				TVoxelRange<v_flt> Variable_48; // 2D Noise SDF.* output 0
				Variable_48 = Variable_19 * TVoxelRange<v_flt>(50.0f);
				
				// Cave Layer.*
				BufferConstant.Variable_29 = Variable_16 * TVoxelRange<v_flt>(50.0f);
				
				// Cave Layer.*
				BufferConstant.Variable_36 = Variable_15 * TVoxelRange<v_flt>(50.0f);
				
				// Cave Layer.1 - X
				TVoxelRange<v_flt> Variable_33; // Cave Layer.1 - X output 0
				Variable_33 = 1 - BufferConstant.Variable_36;
				
				// 2D Noise SDF.+
				BufferConstant.Variable_3 = Variable_48 + TVoxelRange<v_flt>(0.0f);
				
				// *
				BufferConstant.Variable_6 = Variable_8 * TVoxelRange<v_flt>(100.0f);
				
				// Cave Layer.1 - X
				TVoxelRange<v_flt> Variable_26; // Cave Layer.1 - X output 0
				Variable_26 = 1 - BufferConstant.Variable_29;
				
				// Cave Layer.1 - X
				TVoxelRange<v_flt> Variable_41; // Cave Layer.1 - X output 0
				Variable_41 = 1 - BufferConstant.Variable_44;
				
				// Cave Layer.*
				BufferConstant.Variable_46 = TVoxelRange<v_flt>(0.2f) * Variable_41;
				
				// Cave Layer.*
				BufferConstant.Variable_31 = TVoxelRange<v_flt>(0.2f) * Variable_26;
				
				// Cave Layer.*
				BufferConstant.Variable_38 = TVoxelRange<v_flt>(0.2f) * Variable_33;
	...
	private:
		...
		void Function0_XYZWithoutCache_Compute(const FVoxelContextRange& Context, FOutputs& Outputs) const
		{
			...
			Variable_35 = BufferConstant.Variable_36 - Variable_0;
			
			// Cave Layer.-
			TVoxelRange<v_flt> Variable_34; // Cave Layer.- output 0
			Variable_34 = Variable_0 - BufferConstant.Variable_38;
			...
			// Cave Layer.Smooth Union
			TVoxelRange<v_flt> Variable_32; // Cave Layer.Smooth Union output 0
			Variable_32 = FVoxelSDFNodeFunctions::SmoothUnion(Variable_34, Variable_35, TVoxelRange<v_flt>(100.0f));
			
			// Cave Layer.-
			TVoxelRange<v_flt> Variable_27; // Cave Layer.- output 0
			Variable_27 = Variable_1 - BufferConstant.Variable_31;
			
			// 2D Noise SDF.-
			TVoxelRange<v_flt> Variable_47; // 2D Noise SDF.- output 0
			Variable_47 = Variable_18 - BufferConstant.Variable_3;
			...
			Variable_28 = BufferConstant.Variable_29 - Variable_1;
			...
			Variable_42 = Variable_4 - BufferConstant.Variable_46;
			
			// Cave Layer.-
			TVoxelRange<v_flt> Variable_43; // Cave Layer.- output 0
			Variable_43 = BufferConstant.Variable_44 - Variable_4;
			
			// Cave Layer.+
			TVoxelRange<v_flt> Variable_37; // Cave Layer.+ output 0
			Variable_37 = Variable_32 + TVoxelRange<v_flt>(25.0f);
			
			// Cave Layer.Smooth Union
			TVoxelRange<v_flt> Variable_25; // Cave Layer.Smooth Union output 0
			Variable_25 = FVoxelSDFNodeFunctions::SmoothUnion(Variable_27, Variable_28, TVoxelRange<v_flt>(100.0f));
			
			// Cave Layer.Smooth Union
			TVoxelRange<v_flt> Variable_40; // Cave Layer.Smooth Union output 0
			Variable_40 = FVoxelSDFNodeFunctions::SmoothUnion(Variable_42, Variable_43, TVoxelRange<v_flt>(100.0f));
			
			// * -1
			TVoxelRange<v_flt> Variable_20; // * -1 output 0
			Variable_20 = Variable_47 * -1;
			
			// Cave Layer.+
			TVoxelRange<v_flt> Variable_30; // Cave Layer.+ output 0
			Variable_30 = Variable_25 + TVoxelRange<v_flt>(25.0f);
			
			// Cave Layer.+
			TVoxelRange<v_flt> Variable_45; // Cave Layer.+ output 0
			Variable_45 = Variable_40 + TVoxelRange<v_flt>(25.0f);
			
			// Max (float)
			TVoxelRange<v_flt> Variable_2; // Max (float) output 0
			Variable_2 = FVoxelNodeFunctions::Max<v_flt>(Variable_7, FVoxelNodeFunctions::Max<v_flt>(Variable_37, FVoxelNodeFunctions::Max<v_flt>(Variable_30, FVoxelNodeFunctions::Max<v_flt>(Variable_45, Variable_20))));
			
			// *
			TVoxelRange<v_flt> Variable_23; // * output 0
			Variable_23 = BufferConstant.Variable_22 * Variable_2;
			
			// *
			TVoxelRange<v_flt> Variable_24; // * output 0
			Variable_24 = Variable_23 * TVoxelRange<v_flt>(-1.0f);
			
			// Smooth Intersection
			TVoxelRange<v_flt> Variable_12; // Smooth Intersection output 0
			Variable_12 = FVoxelSDFNodeFunctions::SmoothIntersection(Variable_24, Variable_13, TVoxelRange<v_flt>(5.0f));
			
			// Set High Quality Value.*
			TVoxelRange<v_flt> Variable_39; // Set High Quality Value.* output 0
			Variable_39 = Variable_12 * TVoxelRange<v_flt>(0.2f);
			
			Outputs.Value = Variable_39;
		}
