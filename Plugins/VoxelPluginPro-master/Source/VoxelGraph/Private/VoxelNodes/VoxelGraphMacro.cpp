...
TSharedPtr<FVoxelCompilationNode> UVoxelGraphMacroInputOutputNode::GetCompilationNode(const FVoxelGraphContext& Context) const
{
	return MakeShared<FVoxelMacroInputOutputCompilationNode>(Context, *this);
}
...
TSharedPtr<FVoxelCompilationNode> UVoxelGraphMacroNode::GetCompilationNode(const FVoxelGraphContext& Context) const
{
	return MakeShared<FVoxelMacroCompilationNode>(Context, *this);
}
